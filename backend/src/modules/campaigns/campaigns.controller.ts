...
export class CampaignsController {
  ...
  @Get('admin/campaigns/batches')
  listSelectableBatches(@Query('variantId') variantId: string) {
    return this.campaignsService.listSelectableBatches(variantId);
  }
  ...
  @ApiBearerAuth()
  @Roles(ROLE.ADMIN, ROLE.SUPER_ADMIN)
  @Patch('admin/campaigns/:id/cancel')
